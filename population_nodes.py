...
lines = Nodes.transform_regression('Population', 'Nodes', groupby=['Type'], params=True).mark_line()
...
altair_viewer.show(Nodes+Nodes.transform_regression('Population', 'Nodes', groupby=['Type']).mark_line().interactive() + text + text2 + text3 + text4 + text5)
